    ...
    return (
        <div className="flex flex-col items-center justify-center px-6 py-12 min-h-full">
            ...
            <div className="max-w-xl text-center">
                ...
                <ul className="list-disc list-inside text-gray-600 mb-8 space-y-2 text-left">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-700 max-w-md mx-auto">
                <strong>Note:</strong> Currently, only{" "}
                <code className="font-mono bg-blue-100 px-1 rounded">.mp4</code> files are supported
                for upload and processing. Support for additional video formats will be added in future updates.
            </div>
        </div>
    );
};
